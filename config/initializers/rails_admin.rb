# RailsAdmin config file. Generated on November 14, 2012 21:18
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Fooc Us App', 'Admin']
  ...
  # config.excluded_models = ['Task', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Task', 'User']
